...
6. Закрыть QA-блок: Playwright E2E, нагрузочный тест на 50 пользователей, Precision@3 и финальный user guide.
...
| QA | Написать Playwright E2E, подготовить отчет по нагрузке, сделать Precision@3 таблицу и обновить user guide. |
